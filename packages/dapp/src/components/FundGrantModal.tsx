...
export const FundGrantModal: React.FC<Props> = ({
  ...
  const onSubmit = async () => {
    ...
    if (split) {
      const streamAddress = await createStream(
        ethersProvider,
        grantAddress,
        duration,
        amount,
      ...
      await fundGrant(ethersProvider, grantAddress, amount);
    }
  };
  return (
      ...
      <ModalOverlay>
        ...
        >
          ...
          <VStack spacing={4} w="100%" py={6}>
            ...
            <Text textTransform="uppercase">Choose A Distribution Method</Text>
