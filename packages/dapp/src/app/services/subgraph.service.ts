...
export class SubgraphService {
  ...
  getGrantByAddress(grantAddress: string) {
    return this.apollo.query({
      query: gql`
        query getContract($grantAddress: String) {
  ...
  getGrantByCreateby(createBy: string) {
    return this.apollo.query({
      query: gql`
        query getContract($createBy: String) {
          contracts(where: { createBy: $createBy }) {
            id
            input
            uri
            contractAddress
  ...
  getManageByCreateby(manager: string) {
    return this.apollo.query({
      query: gql`
        query getContract($manager: String) {
          contracts(where: { manager: $manager }) {
            id
            input
            uri
            contractAddress
  ...
  getFundByContractAndDonor(grantAddress: string, donor: string) {
    return this.apollo.query({
      query: gql`
        query getFunds($grantAddress: String, $donor: String) {
          funds(where: { grantAddress: $grantAddress, donor: $donor }) {
            id
            grantAddress
            donor
            amount
  ...
  getFundByContract(grantAddress: string) {
    return this.apollo.query({
      query: gql`
        query getFunds($grantAddress: String) {
          funds(where: { grantAddress: $grantAddress }) {
            id
            grantAddress
            donor
            amount
  ...
  getPaymentByContractAndDonor(grantAddress: string, grantee: string) {
    return this.apollo.query({
      query: gql`
        query getPayments($grantAddress: String, $grantee: String) {
          payments(where: { grantAddress: $grantAddress, grantee: $grantee }) {
            id
            grantAddress
            grantee
            amount
